			...
			<div className='coupon-cart cmb-7'>
				<div className='container'>
					<div className='row justify-content-between'>
						<div className='col-md-6 mb-4' data-aos='fade-up' data-aos-duration='500'>
							<div className='coupon-inside'>
								<h2>Discount Coupon Codes</h2>
								<p>
									Enter your coupon code if you have one and get discount up to 50% offer you will get discount with
									free shipping.
								</p>
								<form action='#'>
									<div className='coupon-form'>
										<input type='text' className='form-control coupon-input' placeholder='Input Your Coupon Code' />
						...
						<div className='col-md-4 mb-4' data-aos='fade-up' data-aos-duration='500'>
