						...
						<div className='quick-view-container'>
							...
							<div className='quick-view-text-container'>
								...
								<div className='quick-view-price-rating'>
									<h4 className='quick-view-price-range mt-15'>$ {product.price}</h4>
								</div>
								<div className='quick-view-product-infos'>
									<p>
										Indulge in the exquisite flavors of our Grilled Salmon with Lemon Butter Sauce, a culinary
										masterpiece that's both healthy and mouthwateringly delicious. This dish features a perfectly
										grilled salmon fillet, renowned for its tender, flaky texture and rich, savory taste.
									</p>
								</div>
