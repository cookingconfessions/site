...
const ResetPasswordSuccess: React.FC = () => {
	const { retryPasswordReset } = useAppContext();

	return (
		<div className='container text-center'>
			<h4 className='mb-4'>Password reset email sent</h4>
			<svg
			...
			<div className='about-des pt-15'>
				We've sent you a password reset email. <br /> Please follow the
				instructions provided to set a new password. <br />
			...
			<div className='row'>
				<div className='text-center  my-4' onClick={() => retryPasswordReset()}>
